...
public:
    ...
    ~ParticlePipeline() {
        ...
        if (quadVertexBuffer    != VK_NULL_HANDLE) vkDestroyBuffer(ctx_.device, quadVertexBuffer, nullptr);
    ...
    void recordParticles(VkCommandBuffer cmd) {
        ...
        VkBuffer bufs[]        = { quadVertexBuffer, instanceBuffer };
        ...
        vkCmdDraw(cmd, 6, instanceCount_, 0, 0);
    }
...
private:
    ...
    void createQuadVertexBuffer() {
        ...
        void* data;
        vkMapMemory(ctx_.device, quadVertexMemory, 0, size, 0, &data);
        memcpy(data, quad, size);
        vkUnmapMemory(ctx_.device, quadVertexMemory);
    }
